      ...
      <div className="nav-menu__section">
        ...
        <div className="nav-menu__links-container nav-menu__links-container--main">
          <NavLink
            to="/"
            className={({ isActive }) =>
              isActive ? 'nav-menu__overview nav-menu-link active' : 'nav-menu__overview nav-menu-link'
            }>Overview</NavLink>
          <NavLink
            to="/alljobs"
            className={({ isActive }) =>
              isActive ? 'nav-menu__all-jobs nav-menu-link active' : 'nav-menu__all-jobs nav-menu-link'
            }>All Jobs</NavLink>
          <NavLink
            to="/addjob"
            className={({ isActive }) =>
              isActive ? 'nav-menu__add-job nav-menu-link active' : 'nav-menu__add-job nav-menu-link'
            }>Add Job</NavLink>
        </div>
